  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="panel panel-bd lobidrag lobipanel lobipanel-sortable">
        <div class="panel-heading client-inform">
          <div class="btn-group inform-btn">
            <ul class="nav nav-tabs iconess">
              ...
              <?php endif; ?>
              <li class=""><a href="#profile" data-toggle="tab" aria-expanded="false"><span class="tabnone">Profile</span> <i class="fa fa-user" aria-hidden="true"></i></a></li>
              <?php if(isset($_GET['edit']) && !empty($_GET['edit'])):?>
        ...
        <div class="panel-body add-client">
          <div class="cards-tab">
            <div class="tab-content">
              ...
              <div class="tab-pane fade active in" id="Summary">
                <div class="col-sm-6 col-xs-12">
                  <div class="cardses">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="address-sec">Client Information</div>
                      </div>
                         ...
                         <div class="table-responsive mob-bord">  <table class="table">
                            <tbody>
                              <tr>
                                <td>Full Name</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_name) ? $client->client_name : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Company Name</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_company) ? $client->client_company : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Email ID</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_email) ? $client->client_email : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Full Address</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_fulladdress) ? $client->client_fulladdress : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>City</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_city) ? 
                                    $client->client_city : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>State</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_state) ? 
                                    get_module_value($client->client_state,'state') : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Pincode</td>
                                <td class="type-info">
                                <?php echo isset($client->client_pincode) ? $client->client_pincode : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Country</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_country) ? 
                                    get_module_value($client->client_country,'country') : ''; ?>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                          ...
                          <div class="table-responsive mob-bord"> <table class="table">
                            <tbody>
                              <tr>
                                <td>GST Number </td>
                                <td class="type-info">
                                    <?php echo isset($client->client_gst) ? $client->client_gst : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>PAN Number </td>
                                <td class="type-info">
                                    <?php echo isset($client->client_pan) ? $client->client_pan : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>CIN </td>
                                <td class="type-info">
                                    <?php echo isset($client->client_cin) ? $client->client_cin : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Status</td>
                                <td class="type-info">
                                    <?php echo isset($client->client_status) && $client->client_status == 1
                                    ? 'Active' : 'In-active'; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Signup Date</td>
                                <td class="type-info">
                                    <?php echo isset($client->created) ? 
                                    get_formatted_date($client->created) : ''; ?>
                                </td>
                              </tr>
                              <tr>
                                <td>Duration</td>
                                <td class="type-info">
                                    <?php echo isset($client->created) ? dateDiffInDays($client->created) : '';?>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                     ...
                     <div class="headding_ex">
                        ...
                        <div class="table-responsive mob-bord"> <table class="table">
                          <tbody>
                            <tr>
                              <td>Paid</td>
                              <td class="type-info">
                                  <?php echo get_client_paid_no(isset($client->client_id)? $client->client_id : '') ?>
                                  (<?=get_formatted_price(get_client_paid(isset($client->client_id)? $client->client_id : ''))?>)
                              </td>
                            </tr>
                            <tr>
                              <td>Unpaid/Due</td>
                              <td class="type-info">
                                  <?php echo get_client_unpaid_no(isset($client->client_id)? $client->client_id : '') ?>
                                  (<?=get_formatted_price(get_client_unpaid(isset($client->client_id)? $client->client_id : ''))?>)
                              </td>
                            </tr>
                            <tr>
                              <td>Income</td>
                              <td class="type-info"><?=get_formatted_price(get_client_paid(isset($client->client_id)? $client->client_id : ''))?></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div class="service">
                        <ul>
                          ...
                          <?= get_client_services($client->client_id)?>
                          <?php endif;?>
                        </ul>
                      </div>
                      <form method="post" name="saveAdminNote" id="saveAdminNote">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" tabindex="<?=$tabindex+1?>" rows="3" placeholder="Admin note..." id="snoteText" name="snoteText"><?=$client->admin_note?></textarea>
                          </div>
                        </div>
                          ...
                          <div class="modal-dialog">
                            ...
                            <form name="sendSmsForm" id="sendSmsForm" method="POST">
                              ...
                              <div class="modal-body">
                                <input type="hidden" name="client_id" 
                            value="<?=$client->client_id?>" />
                            <input type="hidden" name="client_mobile" 
                      ...
                      <div class="row">
                          <div class="col-md-12">
                        <form action="<?=base_url()?>client/send_template_email?c=<?php echo isset($_GET['edit']) ? $_GET['edit'] : '';?>" 
                        method="post">
              ...
              <?php endif;?>
              <!---------------------------------------------tab2------------------------------->
              <div class="tab-pane fade <?php echo !isset($_GET['edit']) ? 'active in' : '';?>" id="profile">
                <form method="post" name="clientAdd" id="clientAdd">
                      ...
                      <div class="row">
                        <div class="card-headers">
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              <input type="hidden" name="client_id" 
                              value="<?php echo isset($client->client_id) ? 
                              $client->client_id : ''; ?>" />
                              <input type="text" class="form-control" name="full_name"
                              placeholder="Full Name" value="<?php echo isset($client->client_name) ? 
                              $client->client_name : (isset($_SESSION['dback']['client_name']) ? $_SESSION['dback']['client_name']: ''); ?>" required="" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Company" value="<?php echo isset($client->client_company) ? 
                              $client->client_company : (isset($_SESSION['dback']['client_company']) ? 
                              $_SESSION['dback']['client_company']: ''); ?>" required="" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="PAN Number" value="<?php echo isset($client->client_pan) ? 
                              $client->client_pan : (isset($_SESSION['dback']['client_pan']) ? 
                              $_SESSION['dback']['client_pan']: ''); ?>" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                          <div class="col-md-4 pd-top">
                            <label>CIN</label>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="CIN Number" value="<?php echo isset($client->client_cin) ? 
                              $client->client_cin : (isset($_SESSION['dback']['client_cin']) ? 
                              $_SESSION['dback']['client_cin']: ''); ?>" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Position" value="<?php echo isset($client->client_position) ? 
                              $client->client_position : (isset($_SESSION['dback']['client_position']) ? 
                              $_SESSION['dback']['client_position']: ''); ?>" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                          <?php endif;?>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Email ID" value="<?php echo isset($client->client_email) ? 
                              $client->client_email : (isset($_SESSION['dback']['client_email']) ? 
                              $_SESSION['dback']['client_email']: ''); ?>" required="" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Contact No" value="<?php echo isset($client->client_mobile) ? 
                              $client->client_mobile : (isset($_SESSION['dback']['client_mobile']) ? 
                              $_SESSION['dback']['client_mobile']: ''); ?>" required="" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Alternative No" value="<?php echo isset($client->client_alt_no) ? 
                              $client->client_alt_no : (isset($_SESSION['dback']['client_alt_no']) ? 
                              $_SESSION['dback']['client_alt_no']: ''); ?>" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Website" value="<?php echo isset($client->client_website) ? 
                              $client->client_website : (isset($_SESSION['dback']['client_website']) ? 
                              $_SESSION['dback']['client_website']: ''); ?>" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                          <?php endif;?>
                        ...
                        <div class="card-headers">
                          ...
                          <div class="col-md-8">
                            ...
                            <?php $leadS = get_module_values('lead_source');?>
                              <select name="source" class="form-control" tabindex="<?=$tabindex+1?>">
                                  ...
                                  <option <?php echo isset($client->client_source) && $client->client_source==$l->lead_source_id ? 
                                  'selected' : (isset($_SESSION['dback']['client_source']) && $_SESSION['dback']['client_source'] ==  
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="GST Number" value="<?php echo isset($client->client_gst) ? 
                              $client->client_gst : (isset($_SESSION['dback']['client_gst']) ? $_SESSION['dback']['client_gst']: ''); ?>" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                          <div class="col-md-4 pd-top">
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Full Address" tabindex="<?=$tabindex+1?>"><?php echo isset($client->client_fulladdress) ? 
                              $client->client_fulladdress : (isset($_SESSION['dback']['client_fulladdress']) ? $_SESSION['dback']['client_fulladdress']: ''); ?></textarea>
                            </div>
                          </div>
                          <div class="col-md-4 pd-top">
                            <label>Country</label>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              <select class="form-control select2" name="country" tabindex="<?=$tabindex+1?>">
                                ...
                                <?php echo isset($client->client_country) && $client->client_country == $c->country_id ? 
                                'selected' : (isset($_SESSION['dback']['client_country']) && $_SESSION['dback']['client_country'] ==  
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              <select class="form-control select2" name="state" tabindex="<?=$tabindex+1?>">
                                ...
                                <option value="<?=$s->state_id?>" <?php echo isset($client->client_state) && $client->client_state == $s->state_id ? 
                                'selected' : (isset($_SESSION['dback']['client_state']) && $_SESSION['dback']['client_state'] ==  
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              <input type="text" name="city" value="<?php echo isset($client->client_city) ? 
                              $client->client_city : (isset($_SESSION['dback']['client_city']) ? $_SESSION['dback']['client_city']: ''); ?>" class="form-control" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                          ...
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              placeholder="Pincode" value="<?php echo isset($client->client_pincode) ? 
                                $client->client_pincode : (isset($_SESSION['dback']['client_pincode']) ? $_SESSION['dback']['client_pincode']: ''); ?>" required="" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          ...
                          <div class="col-md-12 text-right">
                            <div class="resets-button">
                               <input type="submit" name="submit" value="Submit" class="btn btn-success form-addclient" tabindex="<?=$tabindex+1?>"/>
                            </div>
                          </div>
                        </div>
                      </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <button type="button" class="btn btn-info btn-xs">
                                    <a href="<?=base_url()?>client/action?editCp=<?=base64_encode($p->client_product_id)?>"><i class="fa fa-pencil"></i></a>
                                  </button>
                                  <a onclick="return confirm('It will delete it Parmamently. Do you want to continue?');"
                                  href="<?=base_url()?>client/action?deleteCp=<?=base64_encode($p->client_product_id)?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
                                </td>
                              </tr>
                            <?php endforeach;?>
                            <?php endif;?>
                  ...
                  <div class="cards">
                    <div class="card-headers">
                      <p style="display: flex;width: 300px;float: right;">
                          ...
                          <a href="<?=base_url()?>create-invoice?ref=<?=base64_encode($client->client_id.'_'.$client->client_name)?>"
                              ...
                              <tr>
                                ...
                                <td>
                                 <button type="button" class="btn btn-success btn-xs">
                                  <a target="_blank" href="<?=base_url()?>client/show_inv?view=<?=base64_encode($i->invoice_id)?>"><i class="fa fa-eye"></i></a>
                                  </button>
                                  <?php if($i->paid_amount == 0):?>
                                  <button type="button" class="btn btn-warning btn-xs" title="Edit Invoice">
                                    <a href="<?=base_url()?>edit-invoice?isc=<?=base64_encode($i->client_id)?>&edit=<?=base64_encode($i->invoice_id)?>"><i class="fa fa-pencil"></i></a>
                                  </button>
                                  <?php endif;?>
                                  <button type="button" class="btn btn-success btn-xs" title="Add Payment">
                                    <a href="<?=base_url()?>invoice/payment/<?=base64_encode($i->invoice_id)?>?isc=<?=base64_encode($i->client_id)?>"><i class="fa fa-money"></i></a>
                                  </button>
                                  <a onclick="return confirm('It will delete it Parmamently. Do you want to continue?');"
                        ...
                        <table class="table table-bordered table-hover" id="emailCtable">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <button type="button" class="btn btn-info btn-xs" onclick="showView('<?=base64_encode($e->client_eh_id)?>','email')"><i class="fa fa-eye"></i></button>
                                </td>
                            </tr>
                            <?php $i++; endforeach;?>
                            <?php endif;?>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><?=$s->sms_subject?><br>
                                  <?=$s->sms_content?></td>
                              <td>
                                <button type="button" class="btn btn-info btn-xs" onclick="showView('<?=base64_encode($s->client_sh_id)?>','sms')"><i class="fa fa-eye"></i></button>
                                </td>
                            </tr>
                            <?php $i++; endforeach;?>
                            <?php endif;?>
