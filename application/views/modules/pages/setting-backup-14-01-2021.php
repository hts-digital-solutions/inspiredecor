         ...
         <div class="panel panel-bd">
            ...
            <div class="row">
               <div class="col-xs-12 col-sm-12 col-md-12 m-b-20">
                  <div class="col-md-2 col-xs-4 p-0">
                     <!-- required for floating -->
                     <!-- Nav tabs -->
                     <ul class="nav nav-tabs tabs-left border-lefttab">
                        <li class="active">
                           <a href="#general" data-toggle="tab"><i class="fa fa-wrench"></i> General Setting</a>
                        </li>
                        <li>
                           <a href="#system" data-toggle="tab"><i class="fa fa-assistive-listening-systems"></i> System Setting</a>
                        </li>
                        <li>
                           <a href="#security" data-toggle="tab"><i class="fa fa-mixcloud "></i> Security Setting</a>
                        </li>
                        <li>
                           <a href="#payment" data-toggle="tab"><i class="fa fa-cog"></i> Payment</a>
                        </li>
                        <li>
                           <a href="#email-setting" data-toggle="tab"><i class="fa fa-envelope"></i> Email Setting</a>
                        </li>
                        <li>
                           <a href="#sms-setting" data-toggle="tab"><i class="fa fa-comments"></i> SMS Setting</a>
                        </li>
                        <li>
                           <a href="#invoice-setting" data-toggle="tab"><i class="fa fa-credit-card-alt"></i> Invoice Setting</a>
                        </li>
                        <li>
                           <a href="#email-template" data-toggle="tab"><i class="fa fa-globe"></i> Email Templates</a>
                        </li>
                        <li>
                           <a href="#department" data-toggle="tab"><i class="fa fa-users"></i> Department</a>
                        </li>
                        <li>
                           <a href="#crm-filed" data-toggle="tab"><i class="fa fa-code"></i> CRM Field</a>
                        </li>
                        <li>
                           <a href="#loginHis" data-toggle="tab"><i class="fa fa-history"></i> Login History</a>
                        </li>
                     </ul>
                  </div>
                  <div class="col-md-10 col-xs-8 p-0">
                     <!-- Tab panels -->
                                       ...
                                       <div class="card-headers">
                                          ...
                                          <div class="col-md-7">
                                             <div class="form-group">
                                                ...
                                                value="<?=get_config_item('company_address')?>"
                                                placeholder="Company Address"  rows="2" required="" /></textarea>
                                             </div>
                                          </div>
                                          <div class="col-md-5 pd-top">
                                             <label>Pincode</label>
                                 ...
                                 <div class="panel panel-default">
                                    ...
                                    <div class="panel-colapse collapse" id="invoice">
                                       ...
                                       <div class="panel-body">
                                          <textarea id="summernote1" name="invoice_email_content"
                                          name="editordata1"><?=get_config_item('invoice_email_content')?></textarea>
                              ...
                              <div class="panel-group" id="accordion2">
                                 <div class="panel panel-default">
                                    ...
                                    <div class="panel-colapse collapse" id="overdue">
                                       ...
                                       <div class="panel-body">
                                          <textarea id="summernote2" name="overdue_email_content"
                                          name="editordata2"><?=get_config_item('overdue_email_content')?></textarea>
                                          ...
                                          <div class="card-headers">
                                             ...
                                             <div class="col-md-3">
                                                <div class="form-group">
                                                   ...
                                                   placeholder="Password" required="" id="apassword"/>
                                                </div>
                                             </div>
                                             <div class="col-md-3">
                                                <div class="form-group">
                               ...
                               <table class="table" id="agentTable">
                                   ...
                                   <tr>
                                       ...
                                       <td>
                                           ...
                                           <a href="<?=base_url()?>agent/del_agent?d=<?=base64_encode($a->agent_id)?>"
                               ...
                               <table class="table" id="loginHisTable">
                                   <thead>
                                       <tr>
                                           ...
                                           class="btn btn-xs btn-danger" style="float:right;">Clear History</a>
                                           </th>
                                       </tr>
                                   </thead>
